...
import { crudeList, pipmonthSwitchs, dic, pipmonthInit } from '@/api/fill'
  ...
  data() {
    return {
      ...
      tableLabel: [
        ...
        { label: '管线进油量(万吨)', param: 'pipelineInputVolume', minWidth: 180 },
        { label: '管线出油量(万吨)', param: 'pipelineOutputVolume', minWidth: 180 },
