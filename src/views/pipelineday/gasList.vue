  ...
  data() {
    return {
      ...
      tableLabel: [
        ...
        { label: '管线进气量', param: 'pipelineInputVolume', minWidth: 180 },
        { label: '管线出气量', param: 'pipelineOutputVolume', minWidth: 180 },
        { label: '管线管存量', param: 'pipelineStock', minWidth: 180 },
        { label: '管线累计输气', param: 'pipelineCumulativeVolume', minWidth: 180 },
        ...
        { label: '设计输气能力', param: 'runPlanPressure', minWidth: 180 },
        { label: '实际输气能力', param: 'runPressure', minWidth: 180 }
      ],
      selectedRows: [],
      pipelineNameTypeAry: [],
      enterNameAry:[]
