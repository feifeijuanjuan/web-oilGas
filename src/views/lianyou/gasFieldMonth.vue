  ...
  data() {
    return {
      ...
      tableLabel: [
        ...
        { label: '原油月加工量', param: 'positionCode', minWidth: 150 },
        { label: '原油计划月加工量', param: 'positionCode', minWidth: 180 },
        { label: '成品油产量', param: 'positionCode', minWidth: 150 },
        { label: '计划成品油月产量', param: 'positionCode', minWidth: 180 },
        { label: '计划负荷率', param: 'positionCode', minWidth: 150 },
        { label: '平均负荷率', param: 'positionCode', minWidth: 150 },
        { label: '89#汽油产量', param: 'positionCode', minWidth: 180 },
        { label: '92#汽油产量', param: 'positionCode', minWidth: 150 },
        { label: '95#汽油产量', param: 'positionCode', minWidth: 180 },
        { label: '负35号柴油产量', param: 'positionCode', minWidth: 180 },
        { label: '负20号柴油产量', param: 'positionCode', minWidth: 180 },
        { label: '负10号柴油产量', param: 'positionCode', minWidth: 180 },
        { label: '0号柴油产量', param: 'positionCode', minWidth: 180 },
        { label: '煤油产量', param: 'positionCode', minWidth: 150 }
      ],
      tableOption: {
        label: '操作',
        width: '200',
