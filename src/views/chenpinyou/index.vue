<template>
  <div class="app-container">
    <div>
      ...
      <!--    弹窗-->
      <add :rowId="rowId" :fasFieldTable="fasFieldTable" :dialogStatu="dialogStatu"
...
import Add from '@/views/chenpinyou/add'

export default {
  name: 'Dashboard',
  components: { TableCmp, Add },
  data() {
    return {
      expandForm: false,
      count: 3,
      ...
      tableLabel: [
        ...
        { label: '原油加工量', param: 'baseStationCode' },
        { label: '成品油产量', param: 'laneCode' },
