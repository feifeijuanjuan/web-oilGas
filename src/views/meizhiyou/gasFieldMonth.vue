  ...
  data() {
    return {
      ...
      tableLabel: [
        ...
        { label: '计划粉煤月加工量', param: 'positionCode' },
        { label: '粉煤月加工量(万吨)', param: 'positionCode' },
        { label: '平均负荷率', param: 'positionCode' },
        { label: '计划平均负荷率', param: 'positionCode' },
        ...
        { label: '干气产量', param: 'positionCode' },
        { label: '石脑油供应量', param: 'positionCode' },
        { label: '柴油供应量', param: 'positionCode' },
        { label: '液化气供应量', param: 'positionCode' },
        { label: '干气供应量', param: 'positionCode' },
        { label: '石脑油销售量', param: 'positionCode' },
        { label: '柴油销售量', param: 'positionCode' },
        { label: '液化气销售量', param: 'positionCode' },
        { label: '干气销售量', param: 'positionCode' },
        { label: '汽运供应量', param: 'positionCode' },
        { label: '管输供应量', param: 'positionCode' },
        { label: '工程车辆销售量', param: 'positionCode' },
        { label: '城市交通销售量', param: 'positionCode' },
        { label: '工业销售量', param: 'positionCode' },
        { label: '乙烯原料销售量', param: 'positionCode' },
        { label: '调合汽油销售量', param: 'positionCode' },
        { label: '重整原料销售量', param: 'positionCode' },
        { label: '原料煤价格', param: 'positionCode' },
        { label: '煤制油品价格', param: 'positionCode' },
        { label: '呼和浩特市销售量', param: 'positionCode' },
        { label: '包头市销售量', param: 'positionCode' },
        { label: '乌海市销售量', param: 'positionCode' },
        { label: '赤峰市销售量', param: 'positionCode' },
        { label: '通辽市销售量', param: 'positionCode' },
        { label: '鄂尔多斯市销售量', param: 'positionCode' },
        { label: '呼伦贝尔市销售量', param: 'positionCode' },
        { label: '巴彦淖尔市销售量', param: 'positionCode' },
        { label: '乌兰察布市销售量', param: 'positionCode' },
        { label: '锡林格勒盟销售量', param: 'positionCode' },
        { label: '阿拉善盟销售量', param: 'positionCode' },
        { label: '兴安盟销售量', param: 'positionCode' },
        { label: '煤制油月产量（万吨）', param: 'positionCode' },
        { label: '计划煤制油月产量（万吨）', param: 'positionCode' }
      ],
      tableOption: {
        label: '操作',
        width: '200',
